import{initializeApp as L}from"https://www.gstatic.com/firebasejs/10.8.0/firebase-app.js";import{getFirestore as M,doc as R,setDoc as k}from"https://www.gstatic.com/firebasejs/10.8.0/firebase-firestore.js";import{getAuth as O}from"https://www.gstatic.com/firebasejs/10.8.0/firebase-auth.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const o of e)if(o.type==="childList")for(const u of o.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&i(u)}).observe(document,{childList:!0,subtree:!0});function d(e){const o={};return e.integrity&&(o.integrity=e.integrity),e.referrerPolicy&&(o.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?o.credentials="include":e.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(e){if(e.ep)return;e.ep=!0;const o=d(e);fetch(e.href,o)}})();const D={apiKey:"AIzaSyAAFXLtkLf55eMIeeTGHpu7KVu-WE9-Zeg",authDomain:"tpms-6e8d8.firebaseapp.com",projectId:"tpms-6e8d8",storageBucket:"tpms-6e8d8.firebasestorage.app",messagingSenderId:"480678660528",appId:"1:480678660528:web:c6e35266d4eb5159d6ee75",measurementId:"G-Z54H1Y13Q0"};let T=null,P=null,N=null,j=!1;try{T=L(D),P=M(T),N=O(T),j=!0,console.log("🔥 Live connected to user Firebase project: TPMS (tpms-6e8d8)!")}catch(n){console.warn("Firebase initialization note:",n)}async function E(n,a){if(P)try{for(const d of a){const i=`${n.toLowerCase()}_id`,e=d[i]?String(d[i]):String(Date.now()),o=R(P,n,e);await k(o,d,{merge:!0})}console.log(`Synced ${a.length} records to Firestore collection: ${n}`)}catch(d){console.warn(`Firestore sync note for ${n}:`,d)}}const I="CTPMS_RELATIONAL_DATABASE_V1",S={ROLE:[{role_id:1,role_name:"Administrator"},{role_id:2,role_name:"TPO"},{role_id:3,role_name:"Student"},{role_id:4,role_name:"Company HR"}],USER:[{user_id:1,name:"Admin Administrator",email:"admin@trcac.edu.in",password:"adminpassword123",role_id:1,is_active:!0},{user_id:2,name:"Prof. Saurabh Vishwakarma (TPO)",email:"tpo@trcac.edu.in",password:"tpopassword123",role_id:2,is_active:!0},{user_id:3,name:"Rahul Sharma",email:"rahul.sharma@trcac.edu.in",password:"studentpassword123",role_id:3,is_active:!0},{user_id:4,name:"Ananya Patel",email:"ananya.patel@trcac.edu.in",password:"studentpassword123",role_id:3,is_active:!0},{user_id:5,name:"Siddharth Verma",email:"siddharth.v@trcac.edu.in",password:"studentpassword123",role_id:3,is_active:!0},{user_id:6,name:"Neha Gupta",email:"neha.gupta@trcac.edu.in",password:"studentpassword123",role_id:3,is_active:!0},{user_id:7,name:"Vikram Singh",email:"vikram.singh@trcac.edu.in",password:"studentpassword123",role_id:3,is_active:!0},{user_id:8,name:"Priya Iyer (TCS HR)",email:"priya.hr@tcs.com",password:"hrpassword123",role_id:4,is_active:!0},{user_id:9,name:"Amitabh Joshi (Google HR)",email:"ajoshi@google.com",password:"hrpassword123",role_id:4,is_active:!0},{user_id:10,name:"Saurabh Vishwakarma (Admin)",email:"cs63saurabh@gmail.com",password:"S1a2u3r4",role_id:1,is_active:!0}],STUDENT:[{student_id:101,user_id:3,roll_number:"TRCAC2024CS001",branch:"B.Sc. CS",cgpa:8.9,skills:"Python, Java, SQL, React, AWS",resume_url:"resumes/rahul_sharma_cv.pdf",placement_status:"Placed"},{student_id:102,user_id:4,roll_number:"TRCAC2024CS002",branch:"B.Sc. CS",cgpa:9.45,skills:"C++, Data Structures, System Design, Node.js",resume_url:"resumes/ananya_patel_cv.pdf",placement_status:"Unplaced"},{student_id:103,user_id:5,roll_number:"TRCAC2024IT015",branch:"B.Sc. IT",cgpa:7.8,skills:"HTML, CSS, JavaScript, PHP, MySQL",resume_url:"resumes/siddharth_v_cv.pdf",placement_status:"Unplaced"},{student_id:104,user_id:6,roll_number:"TRCAC2024DS008",branch:"B.Sc. Data Science",cgpa:8.65,skills:"Python, R, PowerBI, Machine Learning, SQL",resume_url:"resumes/neha_gupta_cv.pdf",placement_status:"Unplaced"},{student_id:105,user_id:7,roll_number:"TRCAC2024CS045",branch:"B.Sc. CS",cgpa:6.75,skills:"HTML, Java, SQL Basics",resume_url:"resumes/vikram_s_cv.pdf",placement_status:"Unplaced"}],COMPANY:[{company_id:201,company_name:"Tata Consultancy Services (TCS)",sector:"IT Services",location:"Mumbai, MH",contact_email:"priya.hr@tcs.com",website:"https://www.tcs.com"},{company_id:202,company_name:"Infosys Limited",sector:"IT & Cloud Services",location:"Bengaluru / Mumbai",contact_email:"campus@infosys.com",website:"https://www.infosys.com"},{company_id:203,company_name:"Google India",sector:"Software & Technology",location:"Hyderabad / Bengaluru",contact_email:"ajoshi@google.com",website:"https://careers.google.com"},{company_id:204,company_name:"Deloitte India",sector:"Consulting & Financial Advisory",location:"Mumbai, MH",contact_email:"hr@deloitte.com",website:"https://www.deloitte.com"}],JOB_POSTING:[{job_id:301,company_id:201,job_title:"Software Engineer - TCS Ninja / Digital",description:"Development and maintenance of enterprise cloud applications. Requires strong problem solving and programming skills.",min_cgpa:7,eligible_branches:"B.Sc. CS, B.Sc. IT, B.Sc. Data Science",ctc:7.5,deadline:"2026-09-15",status:"Open"},{job_id:302,company_id:203,job_title:"Associate Software Engineer",description:"Build scalable software services powering global Google Infrastructure. High algorithmic proficiency required.",min_cgpa:8.5,eligible_branches:"B.Sc. CS, B.Sc. IT",ctc:18,deadline:"2026-09-30",status:"Open"},{job_id:303,company_id:204,job_title:"Risk & Analytics Associate",description:"Perform technical risk modeling, data analytics, and audit compliance for enterprise clients.",min_cgpa:7.5,eligible_branches:"B.Sc. CS, B.Sc. IT, B.Sc. Data Science",ctc:8.75,deadline:"2026-08-30",status:"Open"},{job_id:304,company_id:202,job_title:"Specialist Programmer",description:"Design enterprise software architectures and full-stack solutions.",min_cgpa:8,eligible_branches:"B.Sc. CS, B.Sc. IT",ctc:9.5,deadline:"2026-08-10",status:"Closed"}],APPLICATION:[{application_id:401,student_id:101,job_id:301,applied_date:"2026-08-01 10:30:00",status:"Selected"},{application_id:402,student_id:102,job_id:301,applied_date:"2026-08-02 11:15:00",status:"Shortlisted"},{application_id:403,student_id:102,job_id:302,applied_date:"2026-08-03 14:20:00",status:"Shortlisted"},{application_id:404,student_id:103,job_id:301,applied_date:"2026-08-02 16:45:00",status:"Applied"},{application_id:405,student_id:104,job_id:303,applied_date:"2026-08-04 09:00:00",status:"Shortlisted"}],INTERVIEW:[{interview_id:501,application_id:401,round_number:1,round_type:"Aptitude & Coding Test",scheduled_date:"2026-08-04 10:00:00",venue:"Online Assessment Portal",result:"Pass"},{interview_id:502,application_id:401,round_number:2,round_type:"Technical Interview",scheduled_date:"2026-08-05 14:00:00",venue:"TRCAC Seminar Hall 1",result:"Pass"},{interview_id:503,application_id:401,round_number:3,round_type:"HR Interview",scheduled_date:"2026-08-06 11:30:00",venue:"TPO Conference Room",result:"Pass"},{interview_id:504,application_id:402,round_number:1,round_type:"Aptitude & Coding Test",scheduled_date:"2026-08-10 10:00:00",venue:"TRCAC Computer Lab 3",result:"Pending"},{interview_id:505,application_id:403,round_number:1,round_type:"Technical Screening",scheduled_date:"2026-08-12 15:00:00",venue:"Google Meet (Virtual)",result:"Pending"},{interview_id:506,application_id:405,round_number:1,round_type:"Data Case Study",scheduled_date:"2026-08-11 11:00:00",venue:"TRCAC Lab 2",result:"Pending"}],TRAINING:[{training_id:601,title:"Full-Stack Web & Cloud Boot Camp",trainer_name:"TechSkill Academy",start_date:"2026-07-01",end_date:"2026-07-25",description:"Comprehensive training on React, Node.js, REST APIs, Docker, and AWS deployment.",attendance:[101,102,103],completed_students:[101,102]},{training_id:602,title:"Corporate Communication & Mock HR Interviews",trainer_name:"Prof. Anjali Mehta",start_date:"2026-08-01",end_date:"2026-08-15",description:"Interview body language, group discussion tactics, resume polishing, and aptitude shortcuts.",attendance:[101,102,103,104,105],completed_students:[101]}],PLACEMENT_RECORD:[{placement_id:701,student_id:101,company_id:201,job_id:301,ctc_offered:7.5,offer_date:"2026-08-07",joining_date:"2027-06-15"}],SECURITY_LOG:[{log_id:801,user_id:2,entry_time:"2026-08-08 09:00:00",exit_time:"2026-08-08 17:30:00",status_event:"Success Login"},{log_id:802,user_id:3,entry_time:"2026-08-08 11:14:00",exit_time:"2026-08-08 12:00:00",status_event:"Success Login"},{log_id:803,user_id:1,entry_time:"2026-08-08 14:22:00",exit_time:null,status_event:"Success Login"}]};class q{constructor(){this.init()}init(){if(!localStorage.getItem(I))this.saveAll(S);else{const a=this.getAll();a.USER.some(d=>d.email==="cs63saurabh@gmail.com")||(a.USER.push({user_id:10,name:"Saurabh Vishwakarma (Admin)",email:"cs63saurabh@gmail.com",password:"S1a2u3r4",role_id:1,is_active:!0}),this.saveAll(a))}this.syncAllToFirestore()}async syncAllToFirestore(){try{const a=this.getAll();for(const[d,i]of Object.entries(a))Array.isArray(i)&&i.length>0&&await E(d,i)}catch(a){console.warn("Initial Firestore sync error:",a)}}getAll(){try{const a=localStorage.getItem(I);return a?JSON.parse(a):S}catch(a){return console.error("Error loading DB from LocalStorage",a),S}}saveAll(a){try{localStorage.setItem(I,JSON.stringify(a))}catch(d){console.error("Error saving DB to LocalStorage",d)}}resetToDefault(){return this.saveAll(S),S}getTable(a){return this.getAll()[a]||[]}insertRow(a,d){const i=this.getAll();i[a]||(i[a]=[]);const e=`${a.toLowerCase()}_id`;if(!d[e]){const o=i[a].reduce((u,c)=>c[e]>u?c[e]:u,100);d[e]=o+1}return i[a].push(d),this.saveAll(i),E(a,[d]),d}updateRow(a,d,i){const e=this.getAll(),o=`${a.toLowerCase()}_id`,u=e[a]||[],c=u.findIndex(r=>r[o]===d);return c!==-1?(u[c]={...u[c],...i},e[a]=u,this.saveAll(e),E(a,[u[c]]),u[c]):null}deleteRow(a,d){const i=this.getAll(),e=`${a.toLowerCase()}_id`;return i[a]?(i[a]=i[a].filter(o=>o[e]!==d),this.saveAll(i),!0):!1}getStudentFullProfiles(){const a=this.getAll();return a.STUDENT.map(d=>{const i=a.USER.find(u=>u.user_id===d.user_id)||{},e=a.PLACEMENT_RECORD.find(u=>u.student_id===d.student_id);let o=null;return e&&(o=a.COMPANY.find(u=>u.company_id===e.company_id)),{...d,name:i.name||"Unknown",email:i.email||"",is_active:i.is_active,placement_details:e?{...e,company_name:o==null?void 0:o.company_name}:null}})}getJobPostingsDetailed(){const a=this.getAll();return a.JOB_POSTING.map(d=>{const i=a.COMPANY.find(o=>o.company_id===d.company_id)||{},e=a.APPLICATION.filter(o=>o.job_id===d.job_id);return{...d,company_name:i.company_name||"N/A",sector:i.sector||"N/A",location:i.location||"N/A",application_count:e.length}})}getApplicationsDetailed(){const a=this.getAll();return a.APPLICATION.map(d=>{const i=a.STUDENT.find(r=>r.student_id===d.student_id)||{},e=a.USER.find(r=>r.user_id===i.user_id)||{},o=a.JOB_POSTING.find(r=>r.job_id===d.job_id)||{},u=a.COMPANY.find(r=>r.company_id===o.company_id)||{},c=a.INTERVIEW.filter(r=>r.application_id===d.application_id);return{...d,student_name:e.name||"Unknown Student",roll_number:i.roll_number||"",branch:i.branch||"",cgpa:i.cgpa||0,job_title:o.job_title||"N/A",company_name:u.company_name||"N/A",ctc:o.ctc||0,interviews:c}})}}const p=new q,A="CTPMS_ACTIVE_SESSION";class U{constructor(){this.currentUser=this.loadSession()}loadSession(){try{const a=sessionStorage.getItem(A)||localStorage.getItem(A);return a?JSON.parse(a):null}catch{return null}}login(a,d){const e=p.getTable("USER").find(l=>l.email.toLowerCase()===a.toLowerCase()&&l.password===d);if(!e)return{success:!1,message:"Invalid email credentials or password."};if(!e.is_active)return{success:!1,message:"Account is deactivated. Please contact Administrator."};const u=p.getTable("ROLE").find(l=>l.role_id===e.role_id)||{};let c=null;e.role_id===3&&(c=p.getTable("STUDENT").find(l=>l.user_id===e.user_id)||null);const r={user_id:e.user_id,name:e.name,email:e.email,role_id:e.role_id,role_name:u.role_name||"User",student_id:c?c.student_id:null,login_time:new Date().toISOString()},h=new Date().toISOString().replace("T"," ").substring(0,19),m=p.insertRow("SECURITY_LOG",{user_id:e.user_id,entry_time:h,exit_time:null,status_event:"Success Login"}),b=m.security_log_id||m.log_id||m.id;return r.current_log_id=b,this.currentUser=r,sessionStorage.setItem(A,JSON.stringify(r)),{success:!0,user:r}}logout(){if(this.currentUser){const a=new Date().toISOString().replace("T"," ").substring(0,19);let d=this.currentUser.current_log_id;if(!d){const e=[...p.getTable("SECURITY_LOG")].reverse().find(o=>o.user_id===this.currentUser.user_id&&!o.exit_time);e&&(d=e.security_log_id||e.log_id)}d&&p.updateRow("SECURITY_LOG",d,{exit_time:a,status_event:"Logout"})}this.currentUser=null,sessionStorage.removeItem(A),localStorage.removeItem(A)}switchRole(a){const i=p.getTable("USER").find(e=>e.role_id===a);return i?this.login(i.email,i.password):{success:!1,message:"User for selected role not found."}}getCurrentUser(){return this.currentUser}isAuthenticated(){return!!this.currentUser}}const y=new U;function F(n,a){n.innerHTML=`
  ...
  `;const d=n.querySelector("#login-form"),i=n.querySelector("#login-alert"),e=n.querySelector("#login-password"),o=n.querySelector("#toggle-password"),u=n.querySelector("#toggle-password-icon");o.addEventListener("click",()=>{const c=e.getAttribute("type")==="password";e.setAttribute("type",c?"text":"password"),u.className=c?"bi bi-eye-slash":"bi bi-eye"}),d.addEventListener("submit",c=>{c.preventDefault();const r=n.querySelector("#login-email").value,h=n.querySelector("#login-password").value,m=y.login(r,h);m.success?a():(i.textContent=m.message,i.classList.remove("d-none"))})}function B(n,a){var v;const d=y.getCurrentUser(),i=p.getStudentFullProfiles(),e=p.getTable("COMPANY"),o=p.getJobPostingsDetailed(),u=p.getApplicationsDetailed(),c=p.getTable("PLACEMENT_RECORD"),r=i.length,h=i.filter(g=>g.placement_status==="Placed").length,m=r>0?(h/r*100).toFixed(1):0,b=o.filter(g=>g.status==="Open").length,l=c.reduce((g,f)=>f.ctc_offered>g?f.ctc_offered:g,0),t=c.length>0?(c.reduce((g,f)=>g+f.ctc_offered,0)/c.length).toFixed(2):"0.00";let s="";if(d.role_id===3){const g=i.find(x=>x.user_id===d.user_id)||{},f=u.filter(x=>x.student_id===g.student_id);s=`
    ...
    `}else if(d.role_id===4){const g=p.getTable("USER").find(_=>_.user_id===d.user_id),f=e.find(_=>_.contact_email===g.email)||e[0],x=o.filter(_=>_.company_id===f.company_id),w=u.filter(_=>x.some(C=>C.job_id===_.job_id));s=`
      <div class="row g-4 mb-4">
        <div class="col-md-4">
          <div class="card card-stat p-3 border-0 bg-navy text-white">
            <div class="d-flex justify-content-between align-items-center">
          ...
          <div class="card card-stat p-3">
            <div class="d-flex justify-content-between align-items-center">
              <div>
                ...
                <small class="text-success fw-semibold text-xs"><i class="bi bi-graph-up me-1"></i>${m}% Placement Rate</small>
              </div>
          ...
          <div class="card card-stat p-3">
            <div class="d-flex justify-content-between align-items-center">
              <div>
                ...
                <h3 class="fw-bold text-dark mb-0 mt-1">${b}</h3>
  ...
  `,n.querySelectorAll(".navigate-btn").forEach(g=>{g.addEventListener("click",()=>{const f=g.getAttribute("data-page");a(f)})}),(v=n.querySelector("#refresh-dashboard"))==null||v.addEventListener("click",()=>{B(n,a)})}function H(n){if(y.getCurrentUser().role_id!==1){n.innerHTML=`
    ...
    `;return}function d(){const e=p.getTable("USER"),o=p.getTable("ROLE"),u=n.querySelector("#users-tbody");u&&(u.innerHTML=e.map(c=>{const r=o.find(h=>h.role_id===c.role_id)||{};return`
        <tr>
          <td>
      ...
      `}).join(""),n.querySelectorAll(".toggle-active-btn").forEach(c=>{c.addEventListener("click",()=>{const r=parseInt(c.getAttribute("data-id")),h=e.find(m=>m.user_id===r);h&&(p.updateRow("USER",r,{is_active:!h.is_active}),d())})}),n.querySelectorAll(".edit-user-btn").forEach(c=>{c.addEventListener("click",()=>{const r=parseInt(c.getAttribute("data-id"));i(r)})}))}n.innerHTML=`
    <div class="fade-in">
      <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
  ...
  `,d(),n.querySelector("#add-user-btn").addEventListener("click",()=>{const e=document.getElementById("ctpmsModalTitle"),o=document.getElementById("ctpmsModalBody"),u=document.getElementById("ctpmsModalFooter");e.textContent="Create New User Account",o.innerHTML=`
    ...
    `;const c=new bootstrap.Modal(document.getElementById("ctpmsModal"));c.show(),document.getElementById("submit-new-user").onclick=()=>{const r=document.getElementById("new-user-name").value,h=document.getElementById("new-user-email").value,m=document.getElementById("new-user-pass").value,b=parseInt(document.getElementById("new-user-role").value);if(!r||!h||!m)return;const l=p.insertRow("USER",{name:r,email:h,password:m,role_id:b,is_active:!0});b===3&&p.insertRow("STUDENT",{user_id:l.user_id,roll_number:`TRCAC2026CS${Math.floor(100+Math.random()*900)}`,branch:"B.Sc. CS",cgpa:7.5,skills:"HTML, CSS, JavaScript",resume_url:`resumes/student_${l.user_id}.pdf`,placement_status:"Unplaced"}),c.hide(),d()}});function i(e){const u=p.getTable("USER").find(b=>b.user_id===e);if(!u)return;const c=document.getElementById("ctpmsModalTitle"),r=document.getElementById("ctpmsModalBody"),h=document.getElementById("ctpmsModalFooter");c.textContent=`Edit User: ${u.name}`,r.innerHTML=`
    ...
    `;const m=new bootstrap.Modal(document.getElementById("ctpmsModal"));m.show(),document.getElementById("save-edit-user").onclick=()=>{const b=document.getElementById("edit-user-name").value,l=document.getElementById("edit-user-email").value,t=parseInt(document.getElementById("edit-user-role").value);p.updateRow("USER",e,{name:b,email:l,role_id:t}),m.hide(),d()}}}function G(n){const a=y.getCurrentUser(),d=a.role_id===1||a.role_id===2;function i(){const u=p.getStudentFullProfiles(),c=n.querySelector("#filter-branch").value,r=n.querySelector("#filter-status").value,h=parseFloat(n.querySelector("#filter-cgpa").value)||0,m=n.querySelector("#search-student").value.toLowerCase(),b=u.filter(t=>{const s=!c||t.branch===c,v=!r||t.placement_status===r,g=t.cgpa>=h,f=!m||t.name.toLowerCase().includes(m)||t.roll_number.toLowerCase().includes(m)||t.skills.toLowerCase().includes(m);return s&&v&&g&&f}),l=n.querySelector("#students-tbody");if(l){if(b.length===0){l.innerHTML='<tr><td colspan="7" class="text-center py-4 text-muted">No students matching the filter criteria.</td></tr>';return}l.innerHTML=b.map(t=>`
      <tr>
        <td>
    ...
    `).join(""),n.querySelectorAll(".view-student-btn").forEach(t=>{t.addEventListener("click",()=>{const s=parseInt(t.getAttribute("data-id"));e(s)})}),n.querySelectorAll(".edit-student-btn").forEach(t=>{t.addEventListener("click",()=>{const s=parseInt(t.getAttribute("data-id"));o(s)})})}}n.innerHTML=`
    <div class="fade-in">
      <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
  ...
  `,n.querySelector("#search-student").addEventListener("input",i),n.querySelector("#filter-branch").addEventListener("change",i),n.querySelector("#filter-cgpa").addEventListener("change",i),n.querySelector("#filter-status").addEventListener("change",i),i();function e(u){const r=p.getStudentFullProfiles().find(t=>t.student_id===u);if(!r)return;const h=document.getElementById("ctpmsModalTitle"),m=document.getElementById("ctpmsModalBody"),b=document.getElementById("ctpmsModalFooter");h.textContent=`Student Profile: ${r.name}`,m.innerHTML=`
      <div class="row g-4">
    ...
    `,new bootstrap.Modal(document.getElementById("ctpmsModal")).show()}function o(u){const r=p.getStudentFullProfiles().find(t=>t.student_id===u);if(!r)return;const h=document.getElementById("ctpmsModalTitle"),m=document.getElementById("ctpmsModalBody"),b=document.getElementById("ctpmsModalFooter");h.textContent=`Update Student Eligibility: ${r.name}`,m.innerHTML=`
    ...
    `;const l=new bootstrap.Modal(document.getElementById("ctpmsModal"));l.show(),document.getElementById("save-student-changes").onclick=()=>{const t=parseFloat(document.getElementById("edit-student-cgpa").value),s=document.getElementById("edit-student-status").value,v=document.getElementById("edit-student-skills").value;p.updateRow("STUDENT",u,{cgpa:t,placement_status:s,skills:v}),l.hide(),i()}}}function J(n,a){var c;const d=y.getCurrentUser(),i=d.role_id===1||d.role_id===2;function e(){const r=p.getTable("COMPANY"),h=p.getTable("JOB_POSTING"),m=n.querySelector("#companies-grid");m&&(m.innerHTML=r.map(b=>{const l=h.filter(t=>t.company_id===b.company_id&&t.status==="Open").length;return`
        <div class="col-md-6 col-lg-4">
          <div class="card border-0 shadow-sm rounded-4 h-100 p-3 bg-white">
            <div class="d-flex align-items-center gap-3 mb-3">
              ...
              <div>
                <h6 class="fw-bold mb-0 text-navy">${b.company_name}</h6>
                <span class="badge bg-light text-secondary border text-xs mt-1">${b.sector}</span>
              </div>
            </div>
            <div class="border-top pt-2.5 mb-3 fs-7">
              <div class="text-muted mb-1"><i class="bi bi-geo-alt me-1 text-danger"></i>${b.location}</div>
              <div class="text-muted mb-1"><i class="bi bi-envelope me-1 text-primary"></i>${b.contact_email}</div>
              <div class="text-muted"><i class="bi bi-globe me-1 text-teal"></i><a href="${b.website}" target="_blank" class="text-decoration-none text-muted">${b.website}</a></div>
            </div>
            <div class="d-flex justify-content-between align-items-center border-top pt-2 mt-auto">
              ...
              ${i?`
                <div>
                  <button class="btn btn-xs btn-outline-primary rounded-pill edit-company-btn me-1" data-id="${b.company_id}">Edit</button>
                  <button class="btn btn-xs btn-outline-dark rounded-pill view-drives-btn" data-id="${b.company_id}">View Drives</button>
                </div>
              `:""}
            </div>
          </div>
        </div>
      `}).join(""),n.querySelectorAll(".edit-company-btn").forEach(b=>{b.addEventListener("click",()=>{const l=parseInt(b.getAttribute("data-id"));u(l)})}),n.querySelectorAll(".view-drives-btn").forEach(b=>{b.addEventListener("click",()=>{a("jobs")})}))}n.innerHTML=`
    <div class="fade-in">
      <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
  ...
  `,e(),i&&((c=n.querySelector("#add-company-btn"))==null||c.addEventListener("click",()=>{o()}));function o(){const r=document.getElementById("ctpmsModalTitle"),h=document.getElementById("ctpmsModalBody"),m=document.getElementById("ctpmsModalFooter");r.textContent="Register New Recruiting Company",h.innerHTML=`
    ...
    `;const b=new bootstrap.Modal(document.getElementById("ctpmsModal"));b.show(),document.getElementById("save-new-company").onclick=()=>{const l=document.getElementById("comp-name").value,t=document.getElementById("comp-sector").value,s=document.getElementById("comp-location").value,v=document.getElementById("comp-email").value,g=document.getElementById("comp-website").value;!l||!v||(p.insertRow("COMPANY",{company_name:l,sector:t,location:s,contact_email:v,website:g}),b.hide(),e())}}function u(r){const m=p.getTable("COMPANY").find(v=>v.company_id===r);if(!m)return;const b=document.getElementById("ctpmsModalTitle"),l=document.getElementById("ctpmsModalBody"),t=document.getElementById("ctpmsModalFooter");b.textContent=`Edit Company: ${m.company_name}`,l.innerHTML=`
      <form id="edit-company-form">
        <div class="mb-3">
          <label class="form-label text-xs fw-bold text-uppercase text-muted">Company Official Name</label>
          <input type="text" id="edit-comp-name" class="form-control" value="${m.company_name}" required>
        </div>
        <div class="mb-3">
          <label class="form-label text-xs fw-bold text-uppercase text-muted">Industry Sector</label>
          <input type="text" id="edit-comp-sector" class="form-control" value="${m.sector}" required>
        </div>
        <div class="mb-3">
          <label class="form-label text-xs fw-bold text-uppercase text-muted">Location</label>
          <input type="text" id="edit-comp-location" class="form-control" value="${m.location}" required>
        </div>
        <div class="mb-3">
          <label class="form-label text-xs fw-bold text-uppercase text-muted">HR Contact Email</label>
          <input type="email" id="edit-comp-email" class="form-control" value="${m.contact_email}" required>
        </div>
        <div class="mb-3">
          <label class="form-label text-xs fw-bold text-uppercase text-muted">Website</label>
          <input type="url" id="edit-comp-website" class="form-control" value="${m.website}" required>
        </div>
      </form>
    `,t.innerHTML=`
      <button type="button" class="btn btn-light rounded-pill px-4" data-bs-dismiss="modal">Cancel</button>
      <button type="button" class="btn btn-primary rounded-pill px-4" id="save-edit-company">Save Changes</button>
    `;const s=new bootstrap.Modal(document.getElementById("ctpmsModal"));s.show(),document.getElementById("save-edit-company").onclick=()=>{const v=document.getElementById("edit-comp-name").value,g=document.getElementById("edit-comp-sector").value,f=document.getElementById("edit-comp-location").value,x=document.getElementById("edit-comp-email").value,w=document.getElementById("edit-comp-website").value;p.updateRow("COMPANY",r,{company_name:v,sector:g,location:f,contact_email:x,website:w}),s.hide(),e()}}}function V(n,a){const d=p.getStudentFullProfiles(),i=p.getJobPostingsDetailed(),e=d.find(u=>u.student_id===n),o=i.find(u=>u.job_id===a);if(!e)return{eligible:!1,reason:"Student profile not found."};if(!o)return{eligible:!1,reason:"Job drive not found."};if(o.status!=="Open")return{eligible:!1,reason:`Job drive is currently ${o.status.toLowerCase()}.`};if(e.placement_status==="Placed")return{eligible:!1,reason:"You have already accepted a final placement offer and are ineligible for further drives."};if(e.placement_status==="Opted Out")return{eligible:!1,reason:"Your status is currently set to Opted Out."};if(e.cgpa<o.min_cgpa)return{eligible:!1,reason:`Your CGPA (${e.cgpa.toFixed(2)}) is below the required threshold of ${o.min_cgpa.toFixed(2)}.`};if(o.eligible_branches){const u=o.eligible_branches.split(",").map(h=>h.trim().toLowerCase()),c=e.branch.trim().toLowerCase();if(!u.some(h=>c.includes(h)||h.includes(c)))return{eligible:!1,reason:`Your branch (${e.branch}) is not eligible for this drive. Eligible branches: ${o.eligible_branches}.`}}return{eligible:!0,reason:"Eligible to apply."}}function Y(n,a){var h;const d=y.getCurrentUser(),i=d.role_id===1||d.role_id===2||d.role_id===4,e=d.role_id===3,o=e?p.getTable("STUDENT").find(m=>m.user_id===d.user_id):null,u=e&&o?p.getTable("APPLICATION").filter(m=>m.student_id===o.student_id):[];function c(){const m=p.getJobPostingsDetailed(),b=n.querySelector("#jobs-grid");b&&(b.innerHTML=m.map(l=>{let t=null,s=!1;return e&&o&&(s=u.some(v=>v.job_id===l.job_id),t=V(o.student_id,l.job_id)),`
      ...
      `}).join(""),n.querySelectorAll(".apply-job-btn").forEach(l=>{l.addEventListener("click",()=>{const t=parseInt(l.getAttribute("data-id"));o&&(p.insertRow("APPLICATION",{student_id:o.student_id,job_id:t,applied_date:new Date().toISOString().replace("T"," ").substring(0,19),status:"Applied"}),alert("Application submitted successfully!"),c())})}),n.querySelectorAll(".close-drive-btn").forEach(l=>{l.addEventListener("click",()=>{const t=parseInt(l.getAttribute("data-id"));p.updateRow("JOB_POSTING",t,{status:"Closed"}),c()})}),n.querySelectorAll(".open-drive-btn").forEach(l=>{l.addEventListener("click",()=>{const t=parseInt(l.getAttribute("data-id"));p.updateRow("JOB_POSTING",t,{status:"Open"}),c()})}),n.querySelectorAll(".view-apps-btn").forEach(l=>{l.addEventListener("click",()=>{a("applications")})}))}n.innerHTML=`
    <div class="fade-in">
      <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
  ...
  `,c(),i&&((h=n.querySelector("#post-drive-btn"))==null||h.addEventListener("click",()=>{r()}));function r(){const m=p.getTable("COMPANY"),b=document.getElementById("ctpmsModalTitle"),l=document.getElementById("ctpmsModalBody"),t=document.getElementById("ctpmsModalFooter");b.textContent="Post New Campus Job Drive",l.innerHTML=`
      <form id="post-drive-form">
        <div class="mb-3">
          ...
          <select id="drive-company" class="form-select" required>
            ${m.map(v=>`<option value="${v.company_id}">${v.company_name} (${v.sector})</option>`).join("")}
          </select>
        </div>
        <div class="mb-3">
    ...
    `;const s=new bootstrap.Modal(document.getElementById("ctpmsModal"));s.show(),document.getElementById("save-new-drive").onclick=()=>{const v=parseInt(document.getElementById("drive-company").value),g=document.getElementById("drive-title").value,f=parseFloat(document.getElementById("drive-cgpa").value),x=parseFloat(document.getElementById("drive-ctc").value),w=document.getElementById("drive-branches").value,_=document.getElementById("drive-deadline").value,C=document.getElementById("drive-desc").value;!g||!C||(p.insertRow("JOB_POSTING",{company_id:v,job_title:g,description:C,min_cgpa:f,eligible_branches:w,ctc:x,deadline:_,status:"Open"}),s.hide(),c())}}}function W(n,a){const d=y.getCurrentUser(),i=d.role_id===3,e=d.role_id===1||d.role_id===2||d.role_id===4,o=i?p.getTable("STUDENT").find(c=>c.user_id===d.user_id):null;function u(){var l,t;let c=p.getApplicationsDetailed();i&&o&&(c=c.filter(s=>s.student_id===o.student_id));const r=((l=n.querySelector("#filter-app-status"))==null?void 0:l.value)||"",h=((t=n.querySelector("#search-app"))==null?void 0:t.value.toLowerCase())||"",m=c.filter(s=>{const v=!r||s.status===r,g=!h||s.student_name.toLowerCase().includes(h)||s.job_title.toLowerCase().includes(h)||s.company_name.toLowerCase().includes(h);return v&&g}),b=n.querySelector("#applications-tbody");if(b){if(m.length===0){b.innerHTML='<tr><td colspan="7" class="text-center py-4 text-muted">No drive applications found matching your criteria.</td></tr>';return}b.innerHTML=m.map(s=>`
      <tr>
        <td>
    ...
    `).join(""),n.querySelectorAll(".update-status-btn").forEach(s=>{s.addEventListener("click",v=>{v.preventDefault();const g=parseInt(s.getAttribute("data-id")),f=s.getAttribute("data-status");if(p.updateRow("APPLICATION",g,{status:f}),f==="Selected"&&e){const x=p.getApplicationsDetailed().find(w=>w.application_id===g);confirm(`Student ${x.student_name} is marked Selected! Would you like to create a Final Placement Record now?`)&&a("placements")}u()})})}}n.innerHTML=`
    <div class="fade-in">
      <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
  ...
  `,n.querySelector("#search-app").addEventListener("input",u),n.querySelector("#filter-app-status").addEventListener("change",u),u()}function Q(n){var r;const a=y.getCurrentUser(),d=a.role_id===1||a.role_id===2||a.role_id===4,i=a.role_id===3,e=i?p.getTable("STUDENT").find(h=>h.user_id===a.user_id):null;function o(){const h=p.getTable("INTERVIEW"),m=p.getApplicationsDetailed();let b=h.map(t=>{const s=m.find(v=>v.application_id===t.application_id)||{};return{...t,student_name:s.student_name||"N/A",student_id:s.student_id,roll_number:s.roll_number||"",job_title:s.job_title||"N/A",company_name:s.company_name||"N/A"}});i&&e&&(b=b.filter(t=>t.student_id===e.student_id));const l=n.querySelector("#interviews-tbody");if(l){if(b.length===0){l.innerHTML='<tr><td colspan="7" class="text-center py-4 text-muted">No scheduled interview rounds found.</td></tr>';return}l.innerHTML=b.map(t=>`
      <tr>
        <td>
    ...
    `).join(""),n.querySelectorAll(".update-result-btn").forEach(t=>{t.addEventListener("click",()=>{const s=parseInt(t.getAttribute("data-id"));c(s)})})}}n.innerHTML=`
    <div class="fade-in">
      <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
  ...
  `,o(),d&&((r=n.querySelector("#schedule-interview-btn"))==null||r.addEventListener("click",()=>{u()}));function u(){const h=p.getApplicationsDetailed().filter(s=>s.status==="Shortlisted"||s.status==="Applied"),m=document.getElementById("ctpmsModalTitle"),b=document.getElementById("ctpmsModalBody"),l=document.getElementById("ctpmsModalFooter");m.textContent="Schedule Interview Round",b.innerHTML=`
      ...
      <form id="update-result-form">
        <div class="mb-3">
          ...
          <select id="int-result" class="form-select" required>
            <option value="Pending" ${m.result==="Pending"?"selected":""}>Pending</option>
            <option value="Pass" ${m.result==="Pass"?"selected":""}>Pass (Cleared Round)</option>
            <option value="Fail" ${m.result==="Fail"?"selected":""}>Fail (Did Not Clear)</option>
          </select>
        </div>
      </form>
    `,t.innerHTML=`
    ...
    `;const s=new bootstrap.Modal(document.getElementById("ctpmsModal"));s.show(),document.getElementById("save-int-result").onclick=()=>{const v=document.getElementById("int-result").value;p.updateRow("INTERVIEW",h,{result:v}),s.hide(),o()}}}function K(n){var h;const a=y.getCurrentUser(),d=a.role_id===1||a.role_id===2,i=a.role_id===3,e=i?p.getTable("STUDENT").find(m=>m.user_id===a.user_id):null;function o(){const m=p.getTable("TRAINING"),b=n.querySelector("#trainings-grid");b&&(b.innerHTML=m.map(l=>{const t=e&&(l.attendance||[]).includes(e.student_id),s=e&&(l.completed_students||[]).includes(e.student_id);return`
      ...
      `}).join(""),n.querySelectorAll(".enroll-btn").forEach(l=>{l.addEventListener("click",()=>{const t=parseInt(l.getAttribute("data-id")),s=m.find(v=>v.training_id===t);s&&e&&(s.attendance||(s.attendance=[]),s.attendance.includes(e.student_id)||(s.attendance.push(e.student_id),p.updateRow("TRAINING",t,{attendance:s.attendance}),alert("Successfully enrolled in training program!"),o()))})}),n.querySelectorAll(".download-cert-btn").forEach(l=>{l.addEventListener("click",()=>{const t=l.getAttribute("data-title"),s=l.getAttribute("data-student");alert(`Simulated Certificate Downloaded for ${s}
Program: ${t}
Issued by TRCAC Placement Cell`)})}),n.querySelectorAll(".manage-attendance-btn").forEach(l=>{l.addEventListener("click",()=>{const t=parseInt(l.getAttribute("data-id"));c(t)})}),n.querySelectorAll(".issue-cert-btn").forEach(l=>{l.addEventListener("click",()=>{const t=parseInt(l.getAttribute("data-id"));r(t)})}))}n.innerHTML=`
    <div class="fade-in">
      <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
  ...
  `,o(),d&&((h=n.querySelector("#add-training-btn"))==null||h.addEventListener("click",()=>{u()}));function u(){const m=document.getElementById("ctpmsModalTitle"),b=document.getElementById("ctpmsModalBody"),l=document.getElementById("ctpmsModalFooter");m.textContent="Create Skill Training Program",b.innerHTML=`
    ...
    `;const t=new bootstrap.Modal(document.getElementById("ctpmsModal"));t.show(),document.getElementById("save-new-training").onclick=()=>{const s=document.getElementById("tr-title").value,v=document.getElementById("tr-trainer").value,g=document.getElementById("tr-start").value,f=document.getElementById("tr-end").value,x=document.getElementById("tr-desc").value;!s||!v||(p.insertRow("TRAINING",{title:s,trainer_name:v,start_date:g,end_date:f,description:x,attendance:[],completed_students:[]}),t.hide(),o())}}function c(m){const b=p.getTable("TRAINING").find(f=>f.training_id===m),l=p.getStudentFullProfiles();if(!b)return;const t=document.getElementById("ctpmsModalTitle"),s=document.getElementById("ctpmsModalBody"),v=document.getElementById("ctpmsModalFooter");t.textContent=`Attendance List: ${b.title}`,s.innerHTML=`
      <div class="table-responsive">
        <table class="table table-sm table-hover align-middle">
          ...
          <tbody>
            ${l.map(f=>{const x=(b.attendance||[]).includes(f.student_id);return`
                <tr>
                  <td>${f.name}</td>
                  <td>${f.roll_number}</td>
                  <td>
    ...
    `;const g=new bootstrap.Modal(document.getElementById("ctpmsModal"));g.show(),document.getElementById("save-attendance").onclick=()=>{const f=document.querySelectorAll(".att-check"),x=[];f.forEach(w=>{w.checked&&x.push(parseInt(w.getAttribute("data-sid")))}),p.updateRow("TRAINING",m,{attendance:x}),g.hide(),o()}}function r(m){const b=p.getTable("TRAINING").find(f=>f.training_id===m),l=p.getStudentFullProfiles().filter(f=>(b.attendance||[]).includes(f.student_id));if(!b)return;const t=document.getElementById("ctpmsModalTitle"),s=document.getElementById("ctpmsModalBody"),v=document.getElementById("ctpmsModalFooter");t.textContent=`Issue Completion Certificates: ${b.title}`,s.innerHTML=`
      ...
      <div class="table-responsive">
        <table class="table table-sm table-hover align-middle">
          ...
          <tbody>
            ${l.length===0?'<tr><td colspan="3" class="text-center py-3 text-muted">No enrolled students in this training yet.</td></tr>':l.map(f=>{const x=(b.completed_students||[]).includes(f.student_id);return`
                  <tr>
                    <td>${f.name}</td>
                    <td>${f.roll_number}</td>
                    <td>
    ...
    `;const g=new bootstrap.Modal(document.getElementById("ctpmsModal"));g.show(),document.getElementById("save-certs").onclick=()=>{const f=document.querySelectorAll(".cert-check"),x=[];f.forEach(w=>{w.checked&&x.push(parseInt(w.getAttribute("data-sid")))}),p.updateRow("TRAINING",m,{completed_students:x}),g.hide(),o()}}}function z(n){var o;const a=y.getCurrentUser(),d=a.role_id===1||a.role_id===2;function i(){const u=p.getTable("PLACEMENT_RECORD"),c=p.getStudentFullProfiles(),r=p.getTable("COMPANY"),h=p.getTable("JOB_POSTING"),m=u.map(l=>{const t=c.find(g=>g.student_id===l.student_id)||{},s=r.find(g=>g.company_id===l.company_id)||{},v=h.find(g=>g.job_id===l.job_id)||{};return{...l,student_name:t.name||"Unknown Student",roll_number:t.roll_number||"",branch:t.branch||"",company_name:s.company_name||"N/A",job_title:v.job_title||"N/A"}}),b=n.querySelector("#placements-tbody");if(b){if(m.length===0){b.innerHTML='<tr><td colspan="7" class="text-center py-4 text-muted">No placement records recorded yet.</td></tr>';return}b.innerHTML=m.map(l=>`
      <tr>
        <td>
  ...
  `,i(),d&&((o=n.querySelector("#add-placement-btn"))==null||o.addEventListener("click",()=>{e()}));function e(){const u=p.getStudentFullProfiles().filter(t=>t.placement_status!=="Placed"),c=p.getTable("COMPANY"),r=p.getTable("JOB_POSTING"),h=document.getElementById("ctpmsModalTitle"),m=document.getElementById("ctpmsModalBody"),b=document.getElementById("ctpmsModalFooter");h.textContent="Record Final Student Placement Offer",m.innerHTML=`
    ...
    `;const l=new bootstrap.Modal(document.getElementById("ctpmsModal"));l.show(),document.getElementById("save-placement-record").onclick=()=>{const t=parseInt(document.getElementById("pl-student-id").value),s=parseInt(document.getElementById("pl-company-id").value),v=parseInt(document.getElementById("pl-job-id").value),g=parseFloat(document.getElementById("pl-ctc").value),f=document.getElementById("pl-offer-date").value,x=document.getElementById("pl-joining-date").value;!t||!s||!v||(p.insertRow("PLACEMENT_RECORD",{student_id:t,company_id:s,job_id:v,ctc_offered:g,offer_date:f,joining_date:x}),p.updateRow("STUDENT",t,{placement_status:"Placed"}),l.hide(),i())}}}function Z(n){const a=y.getCurrentUser();if(!(a.role_id===1||a.role_id===2)){n.innerHTML=`
      <div class="alert alert-danger rounded-3 p-4">
        <h5 class="fw-bold"><i class="bi bi-shield-lock-fill me-2"></i>Access Restricted</h5>
        <p class="mb-0">Placement analytics and CSV exports are restricted to TPO Officers and Administrators.</p>
      </div>
    `;return}const i=p.getStudentFullProfiles(),e=p.getTable("PLACEMENT_RECORD"),o=p.getTable("COMPANY"),u=i.length,c=i.filter(s=>s.placement_status==="Placed"),r=i.filter(s=>s.placement_status==="Unplaced"),h=e.reduce((s,v)=>v.ctc_offered>s?v.ctc_offered:s,0),m=e.length>0?(e.reduce((s,v)=>s+v.ctc_offered,0)/e.length).toFixed(2):"0.00",l=["B.Sc. CS","B.Sc. IT","B.Sc. Data Science"].map(s=>{const v=i.filter(x=>x.branch===s),g=v.filter(x=>x.placement_status==="Placed"),f=v.length>0?(g.length/v.length*100).toFixed(1):"0.0";return{branch:s,total:v.length,placed:g.length,unplaced:v.length-g.length,rate:f}}),t=o.map(s=>{const v=e.filter(f=>f.company_id===s.company_id),g=v.reduce((f,x)=>x.ctc_offered>f?x.ctc_offered:f,0);return{company:s.company_name,hires:v.length,ctc:g>0?`${g.toFixed(2)} LPA`:"N/A"}});n.innerHTML=`
    <div class="fade-in">
      <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
      ...
      <div class="row g-4 mb-4">
        ...
        <div class="col-md-2.4 col-sm-6">
          <div class="card card-stat p-3">
            ...
            <h3 class="fw-bold text-primary mb-0 mt-1">${m} LPA</h3>
          </div>
        </div>
        <div class="col-md-2.4 col-sm-6">
          <div class="card card-stat p-3">
